...
const PostJobs = () => {
  ...
  const [jobType, setJobType] = useState<string | EJobType | null>(null);
  ...
  return (
    <>
      <Box w={{ base: "100%", lg: "1250px" }} m="auto">
        ...
        <Box
          boxShadow={{ base: "none", lg: "1px 1px 5px 1px gray" }}
          p="20px 30px"
          m="50px 0"
        >
          <Box mb="50px">
          ...
          <Box>
            ...
            >
              <FormControl>
                <FormLabel fontSize="18px" marginBottom="16px">
                  {t("Company.PostAJob.fields.title")}
                </FormLabel>
                <Input
                  backgroundColor="#fff"
                  onChange={(e) => {
