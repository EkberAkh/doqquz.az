...
const EditJobs = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch("https://neo-814m.onrender.com/v1/post/45")
                if (!response.ok) {
                ...
                setSalaryType(t(`Common.SalaryType.${dataa.salaryType}`))
                setJobCategory(t(`Common.INDUSTRIES.${dataa.category}`))
                setSelectedKeywords(dataa.skills)
                // console.log("sagol",dataa.skills.map(item => item.name))
                    ...
                    {data &&
                        <Box >
                            <Flex alignItems='center' gap="30px" m="30px 0">
                                ...
                                <JobCategories setSelectedJobCategory={setJobCategory} selectedJobCategory = {jobCategory} />
                            </Flex>
                            <Flex alignItems='center' gap="30px">
                                <SalaryType
                                    selectedSalary = {salaryType}
                                    setSelectedSalary={setSalaryType}
                                />
                                <Box>
