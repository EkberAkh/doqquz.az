...
export const LatestJobSeekers = () => {
  ...
  const handlePrevSlide = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex === 0 ? DJobSeekers.length - 3 : prevIndex - 3
    );
  };

  const handleNextSlide = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex + 3 >= DJobSeekers.length ? 0 : prevIndex + 3
    );
  };
          ...
          {maxWidth1100Media ? (
            <Box margin='0 auto'>
                      ...
                      >
                        ...
                        >
                          ...
                          <Box marginTop="35px" paddingY="30px" w="100%">
                            ...
                            >
                              {t(
                                "Home.RegisteredJobseekers.actions.viewProfile"
                              )}
                            </Button>
                          </Box>
                        </Center>
              ...
              <Flex justifyContent='center' mt='40px' columnGap='20px'>
                <Button onClick={handlePrevSlide} borderRadius='100px' w='60px' h='60px'>
                  <ChevronLeftIcon height="20px" width="20px" />
                </Button>
                <Button onClick={handleNextSlide}  w='60px' h='60px' borderRadius='100px' >
