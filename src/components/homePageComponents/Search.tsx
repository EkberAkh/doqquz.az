...
export const Search = () => {
    ...
    return (
        <Flex width='100%' mt={{base:"20px",lg:"100px"}} w={'100%'} justify={'center'} >
            ...
            <Box w={{base:"100%",lg:"45%"}} mb={{base:"40px",lg:"0"}}>
                ...
                <InputGroup bgColor={colorObjects.white.main} w='100%' p='10px 12px'
                    ...
                    <Input placeholder={t('Common.location')} fontSize={{base:"16px",lg:"1.2rem"}} outline='none' border='none' />
                </InputGroup>
            ...
            <Box w={{base:"100%",lg:"55%"}} >
                ...
                <Box width='100%'>
                    <InputGroup bgColor={colorObjects.white.main} w='100%' p='10px'
                        ...
                        <Input placeholder={t('Home.Header.placeholders.jobType')} fontSize={{base:"16px",lg:"1.2rem"}}  width={{base:"100%",lg:"81%"}} outline='none' border='none' />
                        <InputRightElement width='8rem' h={'100%'}    display={{base:"none",lg:"flex"}}>
                                <Button
                                    // pr={'10px'}
                                    w='100%'
                                    h='3rem'
